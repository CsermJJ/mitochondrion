...
pdf(file.path(fig.path, "AUC.pdf"), width = cellwidth * ncol(AUC_mat) +6, height = cellheight * nrow(AUC_mat) * 0.45)
draw(hm)
invisible(dev.off())
